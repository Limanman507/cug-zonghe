...
module.exports = {
    ...
    ShowSettings: ApiRootUrl + 'settings/showSettings',//显示设置
    SaveSettings: ApiRootUrl + 'settings/save',//保存设置
    SettingsDetail: ApiRootUrl + 'settings/userDetail',//设置详细
